    ...
    public class GetCalendarTests
    {
        ...
        public async Task GivenCompleteRequest_WhenGetCalendar_ThenAGetReturnsTheCalculatedCalendar()
        {
            ...
            var postBooking1Request = new BookingBindingModel
            {
                 ...
                 Nights = 2,
                 Start = new DateTime(currentDateTime.Year, currentDateTime.Month, currentDateTime.Day).AddDays(1)
            };
            ...
            var postBooking2Request = new BookingBindingModel
            {
                RentalId = postRentalResult.Id,
                Nights = 2,
                Start = new DateTime(currentDateTime.Year, currentDateTime.Month, currentDateTime.Day).AddDays(2)
            };
            ...
            using (var getCalendarResponse = await _client.GetAsync($"/api/v1/calendar?rentalId={postRentalResult.Id}&start={currentDateTime.Year}-{currentDateTime.Month}-{currentDateTime.Day}&nights=5"))
            {
                ...
                Assert.Equal(new DateTime(currentDateTime.Year, currentDateTime.Month, currentDateTime.Day), getCalendarResult.Dates[0].Date);
                Assert.Empty(getCalendarResult.Dates[0].Bookings);
                
                Assert.Equal(new DateTime(currentDateTime.Year, currentDateTime.Month, currentDateTime.Day).AddDays(1), getCalendarResult.Dates[1].Date);
                ...
                Assert.Equal(new DateTime(currentDateTime.Year, currentDateTime.Month, currentDateTime.Day).AddDays(2), getCalendarResult.Dates[2].Date);
                ...
                Assert.Equal(new DateTime(currentDateTime.Year, currentDateTime.Month, currentDateTime.Day).AddDays(3), getCalendarResult.Dates[3].Date);
                ...
                Assert.Equal(new DateTime(currentDateTime.Year, currentDateTime.Month, currentDateTime.Day).AddDays(4), getCalendarResult.Dates[4].Date);
